...
const Blog = () => {
  return (
    <>
      <Head>
        <title>tirelesstraveler Blog</title>
        <meta name="Content-Language" content="EN" />
        <meta name="keywords" content="tirelesstraveler Blog" />
        <meta name="description" content="tirelesstraveler Blog" />
        <link rel="canonical" href="https://www.tirelesstraveler.net/blog" />
                  ...
                  <div className="blog-card" key={i}>
                    ...
                    <div className="blog-content">
                      ...
                      <p className="blog-description">
                        ...
                        Palatine Hill. Aliquam sit amet euismod purus, sed
                  ...
                  .map((item, i) => (
                    <div className="popular-post" key={i}>
                      ...
                      <div className="popular-post-content">
                        <p className="popular-post-title">
                          Trip to Italy: Milan
                        </p>
