...
const About = () => {
  return (
    <>
      <Head>
        <title>About tirelesstraveler </title>
        <meta name="Content-Language" content="EN" />
        <meta name="keywords" content="About tirelesstraveler " />
        <meta name="description" content="About tirelesstraveler " />
        <link
          rel="canonical"
          href="https://www.tirelesstraveler.net/about"
        />
          ...
          <div className="product-container">
            ...
            <div className="product-details">
              ...
              <p>
                ...
                partial hearing loss. He then spent nearly four years working on
                a Scottish-owned tea plantation in Darjeeling before entering
              ...
              <p>
                ...
                him to embrace American life. He obtained a Green Card in 1977
                and became a U.S. citizen by 1979. Over the past four and a half
                decades, he built successful ventures in fashion, sportswear,
                hospitality, and real estate. Residing in Beverly,
                Massachusetts, he married Pamela in 1979, and they have two
                children, Sukhvinder, a fintech professional, and Tasha, a
                lawyer, along with four grandchildren.
              </p>
              <h4>Passion for Exploration and Photography</h4>
              <p>
                A devoted Sikh, Arvi’s adventurous spirit and determination have
                fueled his lifelong passion for travel and photography. He
                earned a pilot’s license for a single-engine plane and took
                helicopter piloting classes to explore and document his
                journeys. Speaking six languages, he has traveled extensively,
                capturing human interactions and landscapes across remote
                regions, including Greenland, the Poles, Patagonia, and the
